...
if __name__ == "__main__":
    ...
    parser.add_argument('-ncl', "--num_clusters", type=int, default=2) # numero de cluster
    parser.add_argument('-tsa', '--type_select', type = str, default='A')
    parser.add_argument('-atk', '--atack', type = str, default='random') 
    parser.add_argument('-snr', '--srn_noise', type = float, default=1)  
    ...
    parser.add_argument('-ratecf', '--rate_client_fake', type = float, default=1) 
    ...
    parser.add_argument('-datk', '--delay_atk', type = int, default=0)
